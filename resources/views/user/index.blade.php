                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"> <span class="btn btn-primary btn-round btn-xs"> <i class="zmdi zmdi-flower-alt"></i></span> Data User</h3>
                            ...
                            <div class="modal-body">
                                <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="name" id="nama" class="form-control" placeholder="Masukan Nama">
                                        </div>
                                    </div>
                                    <div class=" row mb-4">
                                        <label for="inputName" class="col-md-3 form-label">Username</label>
                                        <div class="col-md-9">
                                            <input type="text" name="name" id="nama" class="form-control" placeholder="Masukan Nama Pengguna">
                                        </div>
                                    </div>
                                    <div class=" row mb-4">
    ...
    <script>
        ...
        function fill_datatable() {
            var tabel = $('#tabeluser').DataTable({
                ...
                ajax: {
                    url: "{{ route('user.getDatatablePengguna') }}",
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
