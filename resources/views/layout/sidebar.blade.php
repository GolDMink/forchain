    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="index.html">
                ...
                <img src="assets/images/logo.png" class="header-brand-img toggle-logo" alt="logo">
                <img src="assets/images/logo.png" class="header-brand-img light-logo" alt="logo">
                <img src="{{ asset('assets/images/logo.png') }}" class="header-brand-img light-logo1" width="30px"
                    alt="logo">
            </a>
            <!-- LOGO -->
        </div>
